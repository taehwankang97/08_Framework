...
@Override
	...
	// 3. DB에서 cp(조회 하여는 페이지)에 해당하는 행을 조회
	...
	//4. 목록 조회 결과 + pagenaion 객체를 Map으로 묶어서 반환
	...
	/* ==
	 * Map<String, Object> map2 = Map.of("boradList", boardList,
...
public Board selectDetail(Map<String, Integer> map) {
	...
	/* boardNo처럼 하나의 값을 이용해 여러번 SELECT 수행하는 경우
	 * 
	 * 1. 하나의 Service 메서드에서 
	 * 	여러 Mapper 메서드 호출하기
	 * 
...
public Map<String, Object> boardLike(int boardNo, int memberNo) {
	...
	//3. INSERT,DELETE 성공시 해당 게시글의 좋아요 개수 조회
	int count = 0;
	if(result2 > 0) {
