...
/*----- 메일 발송 -----*/
		...
		// CID(Content-ID)를 이용해 메일에 이미지 첨부
			helper.addInline("logo", 
					new ClassPathResource("static/images/user.png"));
...
@Override
	...
	/*
	 * private 자료형 필드명 1; private 자료형 필드명 2;
	 * 
	 * @Autowired public 클래스명 (자료형 변수명 1, 자료형 변수명 2) { this.필드명1 = 변수명1; this.필드명2 =
	 * 변수명2; }
	 */
